...
const (
	...
	//ES_URL = "http://35.237.140.73:9200"
	ES_URL = "http://10.142.0.2:9200"

	BUCKET_NAME = "for-around-project"
	PROJECT_ID  = "spheric-broker-236002"
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//	err = saveToBT(p, id)
	//	if err != nil {
	//		http.Error(w, "Failed to save post to BT", http.StatusInternalServerError)
	//		fmt.Printf("Failed to save post to BT %v.\n", err)
	//		return
	//	}
